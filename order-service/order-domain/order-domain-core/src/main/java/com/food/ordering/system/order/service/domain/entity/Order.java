...
import com.food.ordering.system.domain.entity.AgregateRoot;
...
public class Order extends AgregateRoot<OrderId> {
    ...
    public void initCancel(List<String> failureMessages) {
        if (orderStatus != OrderStatus.PAID) {
            throw new OrderDomainException("Oder is not in correct state for initCancel operation!");
        }
